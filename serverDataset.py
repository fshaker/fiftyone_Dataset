...
groups = ["LCC", "RCC", "LMLO", "RMLO"]
datasets = fo.list_datasets()
for dataset in datasets:
    data = fo.load_dataset(dataset)
    data.delete()
name = "SegmentAnnotate"
images_dir = r"C:\Users\Admin\Documents\VidaMedicals\Codes\Datasets\Segment+Annotate_v1"
annotations_dir = r"C:\Users\Admin\Documents\VidaMedicals\Codes\Datasets\Segment+Annotate_v1"
...
dataset.add_group_field("group", default="LCC")
for sample in dataset:
    ...
    with open(annotations_path, 'r') as file:
        ...
        for shape in annotations["shapes"]:
            ...
            polygon = polyline/[img_height,img_width]
            detections.append(fo.Detection(label=label,
                                           bounding_box=bounding_box, mask=mask, polygon=polygon))
